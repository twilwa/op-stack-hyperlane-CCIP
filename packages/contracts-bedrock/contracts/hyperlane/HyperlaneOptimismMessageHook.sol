...
// ============ Internal Imports ============
import { IMessageHook } from "@hyperlane-xyz/core/contracts/interfaces/hooks/IMessageHook.sol";
import { OptimismISM } from "@hyperlane-xyz/core/contracts/isms/hook/optimism/OptimismISM.sol";
...
contract HyperlaneOptimismMessageHook is IMessageHook {
    ...
    constructor(
        ...
        // require(_destinationDomain != 0, "OptimismHook: invalid destination domain");
        // require(_ism != address(0), "OptimismHook: invalid ISM");
        destinationDomain = _destinationDomain;

        // require(Address.isContract(_messenger), "OptimismHook: invalid messenger");
        ...
        returns (uint256)
    {
        ...
        require(_destination == destinationDomain, "OptimismHook: invalid destination domain");
