...
import {
    IValidatorAnnounce
} from "@hyperlane-xyz/core/contracts/interfaces/IValidatorAnnounce.sol";
import { IMailbox } from "@hyperlane-xyz/core/contracts/interfaces/IMailbox.sol";
import { TypeCasts } from "@hyperlane-xyz/core/contracts/libs/TypeCasts.sol";
import {
    ValidatorAnnouncements
} from "@hyperlane-xyz/core/contracts/libs/ValidatorAnnouncements.sol";
// ============ External Imports ============
 ...
 */
contract HyperlaneValidatorAnnounce is IValidatorAnnounce {
    // ============ Libraries ============
    ...
    function announce(
        ...
        bytes32 _replayId = keccak256(abi.encodePacked(_validator, _storageLocation));
        ...
        bytes32 _announcementDigest = ValidatorAnnouncements.getAnnouncementDigest(
            mailbox,
            localDomain,
            _storageLocation
        );
